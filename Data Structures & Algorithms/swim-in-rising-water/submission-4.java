            ...
            for (int[] d: directions) {
                ...
                if (nRow >= 0 && nRow < grid.length && nCol >= 0 && nCol < grid[0].length) {
                    ...
                    // key has been visited before    
                        ...
                        // if the newKey has been visited before, I can override it ony if
                        // the value i am bringing is higher than the existing grid value
                        // but lower than the minpeakheight it currently has
