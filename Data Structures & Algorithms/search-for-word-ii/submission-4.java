...
// 1. by marking visited nodes as # in board and unmarking them when done
//.   instead of using a visited set
// 1. storing the word at the Trie when the word ends, instead of using boolean eow, 
//.   this makes us avoid using StringBuilder 
class Solution {
    Trie root;
    Set<String> allWords;
